...
module top ;
	...
	wire [0:0] tmpOE__Pin_1a_Z_net;
	wire [0:0] tmpFB_0__Pin_1a_Z_net;
	wire [0:0] tmpIO_0__Pin_1a_Z_net;
	wire [0:0] tmpINTERRUPT_0__Pin_1a_Z_net;
	electrical [0:0] tmpSIOVREF__Pin_1a_Z_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_1a_Z
		 (.oe(tmpOE__Pin_1a_Z_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_1a_Z_net[0:0]}),
		  .io({tmpIO_0__Pin_1a_Z_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_1a_Z_net),
		  .interrupt({tmpINTERRUPT_0__Pin_1a_Z_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_1a_Z_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_2a_Z_net;
	wire [0:0] tmpFB_0__Pin_2a_Z_net;
	wire [0:0] tmpIO_0__Pin_2a_Z_net;
	wire [0:0] tmpINTERRUPT_0__Pin_2a_Z_net;
	electrical [0:0] tmpSIOVREF__Pin_2a_Z_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("97f55988-0899-4f51-a076-98afb1eb7e9e"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_2a_Z
		 (.oe(tmpOE__Pin_2a_Z_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_2a_Z_net[0:0]}),
		  .io({tmpIO_0__Pin_2a_Z_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_2a_Z_net),
		  .interrupt({tmpINTERRUPT_0__Pin_2a_Z_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_2a_Z_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_1b_Z_net;
	wire [0:0] tmpFB_0__Pin_1b_Z_net;
	wire [0:0] tmpIO_0__Pin_1b_Z_net;
	wire [0:0] tmpINTERRUPT_0__Pin_1b_Z_net;
	electrical [0:0] tmpSIOVREF__Pin_1b_Z_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("30868f49-7b47-4ff2-b3bc-e2e58cb85771"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_1b_Z
		 (.oe(tmpOE__Pin_1b_Z_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_1b_Z_net[0:0]}),
		  .io({tmpIO_0__Pin_1b_Z_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_1b_Z_net),
		  .interrupt({tmpINTERRUPT_0__Pin_1b_Z_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_1b_Z_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_2b_Z_net;
	wire [0:0] tmpFB_0__Pin_2b_Z_net;
	wire [0:0] tmpIO_0__Pin_2b_Z_net;
	wire [0:0] tmpINTERRUPT_0__Pin_2b_Z_net;
	electrical [0:0] tmpSIOVREF__Pin_2b_Z_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("685d155a-30c3-40e9-ae8c-47b00bc2387f"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_2b_Z
		 (.oe(tmpOE__Pin_2b_Z_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_2b_Z_net[0:0]}),
		  .io({tmpIO_0__Pin_2b_Z_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_2b_Z_net),
		  .interrupt({tmpINTERRUPT_0__Pin_2b_Z_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_2b_Z_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Z_interrupt_net;
	wire [0:0] tmpIO_0__Z_interrupt_net;
	wire [0:0] tmpINTERRUPT_0__Z_interrupt_net;
	electrical [0:0] tmpSIOVREF__Z_interrupt_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Z_interrupt
		 (.oe(tmpOE__Z_interrupt_net),
		  .y({1'b0}),
		  .fb({Net_1}),
		  .io({tmpIO_0__Z_interrupt_net[0:0]}),
		  .siovref(tmpSIOVREF__Z_interrupt_net),
		  .interrupt({tmpINTERRUPT_0__Z_interrupt_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Z_interrupt_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__S_interrupt_net;
	wire [0:0] tmpIO_0__S_interrupt_net;
	wire [0:0] tmpINTERRUPT_0__S_interrupt_net;
	electrical [0:0] tmpSIOVREF__S_interrupt_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("694c1808-fcc0-420a-8ef8-ea37f8f22b0c"),
		  ...
		  .input_buffer_sel(2'b00))
		S_interrupt
		 (.oe(tmpOE__S_interrupt_net),
		  .y({1'b0}),
		  .fb({Net_13}),
		  .io({tmpIO_0__S_interrupt_net[0:0]}),
		  .siovref(tmpSIOVREF__S_interrupt_net),
		  .interrupt({tmpINTERRUPT_0__S_interrupt_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__S_interrupt_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
