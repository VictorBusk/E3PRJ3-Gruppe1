...
// IDAC_P4_v1_10(IDACRange=0, IDACValue=16, Polarity=1, Resolution=8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=CapSense:IDAC1, CY_INSTANCE_SHORT_NAME=IDAC1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=true, CY_VERSION=PSoC Creator  3.3 CP2, INSTANCE_NAME=CapSense_IDAC1, )
...
module CapSense_CSD_P4_v2_40_3 ;
	...
	cy_clock_v1_0
		#(.id("b9d739aa-04c7-4498-b2c7-c537d3f9ab85/74063576-f256-4f8f-8a82-9abdee876261"),
	...
	cy_psoc3_pins_v1_10
		#(.id("b9d739aa-04c7-4498-b2c7-c537d3f9ab85/899719c0-e797-4403-a44f-07a66de2cbeb"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b9d739aa-04c7-4498-b2c7-c537d3f9ab85/73b612cd-240c-4d8e-8340-ea28aabf4b11"),
	...
	cy_clock_v1_0
		#(.id("b9d739aa-04c7-4498-b2c7-c537d3f9ab85/9a635726-510c-483c-9c5c-3e233ee2906a"),
		  .source_clock_id("413DE2EF-D9F2-4233-A808-DFAF137FD877"),
		  .divisor(255),
		  .period("0"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__Pin_1a_X_net;
	wire [0:0] tmpFB_0__Pin_1a_X_net;
	wire [0:0] tmpIO_0__Pin_1a_X_net;
	wire [0:0] tmpINTERRUPT_0__Pin_1a_X_net;
	electrical [0:0] tmpSIOVREF__Pin_1a_X_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_1a_X
		 (.oe(tmpOE__Pin_1a_X_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_1a_X_net[0:0]}),
		  .io({tmpIO_0__Pin_1a_X_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_1a_X_net),
		  .interrupt({tmpINTERRUPT_0__Pin_1a_X_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_1a_X_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_2a_X_net;
	wire [0:0] tmpFB_0__Pin_2a_X_net;
	wire [0:0] tmpIO_0__Pin_2a_X_net;
	wire [0:0] tmpINTERRUPT_0__Pin_2a_X_net;
	electrical [0:0] tmpSIOVREF__Pin_2a_X_net;

	cy_psoc3_pins_v1_10
		#(.id("97f55988-0899-4f51-a076-98afb1eb7e9e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_2a_X
		 (.oe(tmpOE__Pin_2a_X_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_2a_X_net[0:0]}),
		  .io({tmpIO_0__Pin_2a_X_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_2a_X_net),
		  .interrupt({tmpINTERRUPT_0__Pin_2a_X_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_2a_X_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_1b_X_net;
	wire [0:0] tmpFB_0__Pin_1b_X_net;
	wire [0:0] tmpIO_0__Pin_1b_X_net;
	wire [0:0] tmpINTERRUPT_0__Pin_1b_X_net;
	electrical [0:0] tmpSIOVREF__Pin_1b_X_net;

	cy_psoc3_pins_v1_10
		#(.id("30868f49-7b47-4ff2-b3bc-e2e58cb85771"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_1b_X
		 (.oe(tmpOE__Pin_1b_X_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_1b_X_net[0:0]}),
		  .io({tmpIO_0__Pin_1b_X_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_1b_X_net),
		  .interrupt({tmpINTERRUPT_0__Pin_1b_X_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_1b_X_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_2b_X_net;
	wire [0:0] tmpFB_0__Pin_2b_X_net;
	wire [0:0] tmpIO_0__Pin_2b_X_net;
	wire [0:0] tmpINTERRUPT_0__Pin_2b_X_net;
	electrical [0:0] tmpSIOVREF__Pin_2b_X_net;

	cy_psoc3_pins_v1_10
		#(.id("685d155a-30c3-40e9-ae8c-47b00bc2387f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_2b_X
		 (.oe(tmpOE__Pin_2b_X_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_2b_X_net[0:0]}),
		  .io({tmpIO_0__Pin_2b_X_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_2b_X_net),
		  .interrupt({tmpINTERRUPT_0__Pin_2b_X_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_2b_X_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_1a_Y_net;
	wire [0:0] tmpFB_0__Pin_1a_Y_net;
	wire [0:0] tmpIO_0__Pin_1a_Y_net;
	wire [0:0] tmpINTERRUPT_0__Pin_1a_Y_net;
	electrical [0:0] tmpSIOVREF__Pin_1a_Y_net;

	cy_psoc3_pins_v1_10
		#(.id("52c3992e-a97f-4954-8e93-b857d46f66ba"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_1a_Y
		 (.oe(tmpOE__Pin_1a_Y_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_1a_Y_net[0:0]}),
		  .io({tmpIO_0__Pin_1a_Y_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_1a_Y_net),
		  .interrupt({tmpINTERRUPT_0__Pin_1a_Y_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_1a_Y_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_2a_Y_net;
	wire [0:0] tmpFB_0__Pin_2a_Y_net;
	wire [0:0] tmpIO_0__Pin_2a_Y_net;
	wire [0:0] tmpINTERRUPT_0__Pin_2a_Y_net;
	electrical [0:0] tmpSIOVREF__Pin_2a_Y_net;

	cy_psoc3_pins_v1_10
		#(.id("9017877c-9cdb-4bf6-9f74-ac19706f16f2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_2a_Y
		 (.oe(tmpOE__Pin_2a_Y_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_2a_Y_net[0:0]}),
		  .io({tmpIO_0__Pin_2a_Y_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_2a_Y_net),
		  .interrupt({tmpINTERRUPT_0__Pin_2a_Y_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_2a_Y_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_1b_Y_net;
	wire [0:0] tmpFB_0__Pin_1b_Y_net;
	wire [0:0] tmpIO_0__Pin_1b_Y_net;
	wire [0:0] tmpINTERRUPT_0__Pin_1b_Y_net;
	electrical [0:0] tmpSIOVREF__Pin_1b_Y_net;

	cy_psoc3_pins_v1_10
		#(.id("d9508a0f-3b66-478d-bd4d-5029034b81d8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_1b_Y
		 (.oe(tmpOE__Pin_1b_Y_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_1b_Y_net[0:0]}),
		  .io({tmpIO_0__Pin_1b_Y_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_1b_Y_net),
		  .interrupt({tmpINTERRUPT_0__Pin_1b_Y_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_1b_Y_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_2b_Y_net;
	wire [0:0] tmpFB_0__Pin_2b_Y_net;
	wire [0:0] tmpIO_0__Pin_2b_Y_net;
	wire [0:0] tmpINTERRUPT_0__Pin_2b_Y_net;
	electrical [0:0] tmpSIOVREF__Pin_2b_Y_net;

	cy_psoc3_pins_v1_10
		#(.id("5e680039-0086-419b-ac01-db63c8919c55"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_2b_Y
		 (.oe(tmpOE__Pin_2b_Y_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_2b_Y_net[0:0]}),
		  .io({tmpIO_0__Pin_2b_Y_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_2b_Y_net),
		  .interrupt({tmpINTERRUPT_0__Pin_2b_Y_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_2b_Y_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__X_interrupt_net;
	wire [0:0] tmpIO_0__X_interrupt_net;
	wire [0:0] tmpINTERRUPT_0__X_interrupt_net;
	electrical [0:0] tmpSIOVREF__X_interrupt_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		X_interrupt
		 (.oe(tmpOE__X_interrupt_net),
		  .y({1'b0}),
		  .fb({Net_3}),
		  .io({tmpIO_0__X_interrupt_net[0:0]}),
		  .siovref(tmpSIOVREF__X_interrupt_net),
		  .interrupt({tmpINTERRUPT_0__X_interrupt_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__X_interrupt_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Y_interrupt_net;
	wire [0:0] tmpIO_0__Y_interrupt_net;
	wire [0:0] tmpINTERRUPT_0__Y_interrupt_net;
	electrical [0:0] tmpSIOVREF__Y_interrupt_net;

	cy_psoc3_pins_v1_10
		#(.id("258dcb93-2fb9-4ae6-864f-30e3c59b13f6"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Y_interrupt
		 (.oe(tmpOE__Y_interrupt_net),
		  .y({1'b0}),
		  .fb({Net_4}),
		  .io({tmpIO_0__Y_interrupt_net[0:0]}),
		  .siovref(tmpSIOVREF__Y_interrupt_net),
		  .interrupt({tmpINTERRUPT_0__Y_interrupt_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Y_interrupt_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("fa7caa7b-6e8d-4577-841f-1a9f0d0c1e9d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3ed6068b-e1fc-433f-9cdc-d486bfbcd291"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d97683ff-adb2-4d6b-804f-19f9cf73ed0e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b41d2be6-5373-4a09-8b7b-31fefbfdae03"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
