...
;==============================================================================
    ...
    IMPORT DEBUG_pinNumber
    IMPORT DEBUG_pinPortNumber
    IMPORT DEBUG_pinDrAdress
...
; void DEBUG_PutChar(uint8 txDataByte)
    ALIGN 8
DEBUG_PutChar FUNCTION
    EXPORT DEBUG_PutChar
...
PIN_NUMBER DCD DEBUG_pinNumber
PORT_NUMBER DCD DEBUG_pinPortNumber
PORT_DR_ADDRESS DCD DEBUG_pinDrAdress
