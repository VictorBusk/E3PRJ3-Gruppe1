...
.global DEBUG_pinNumber
.global DEBUG_pinPortNumber
...
.func DEBUG_PutChar, DEBUG_PutChar
.type DEBUG_PutChar, %function
.thumb_func
DEBUG_PutChar:
...
bitTxLoop:
    ...
    .align 5
PIN_NUMBER:
    .word DEBUG_pinNumber
PORT_NUMBER:
    .word DEBUG_pinPortNumber
PORT_DR_ADDRESS:
    .word DEBUG_pinDrAdress
FREQ:
    .word cydelayFreqHz
BAUD_RATE:
    .word 9600
