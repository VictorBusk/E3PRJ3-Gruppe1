...
void i2c_rx()
{
    if(0u != (I2CS_I2CSlaveStatus() & I2CS_I2C_SSTAT_WR_CMPLT))
    {
        ...
        {
            if((i2c_rxBuffer[I2C_PACKET_SOP_POS] == I2C_PACKET_SOP) && (i2c_rxBuffer[I2C_PACKET_EOP_POS] == I2C_PACKET_EOP))
            {
                struct Data action;
                action.cmd_ = i2c_rxBuffer[I2C_PACKET_CMD_POS];
                action.val_ = i2c_rxBuffer[I2C_PACKET_VAL_POS];
