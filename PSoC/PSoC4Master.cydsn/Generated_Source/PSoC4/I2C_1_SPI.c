    ...
    *******************************************************************************/
    void I2C_1_SpiInit(const I2C_1_SPI_INIT_STRUCT *config)
    {
        ...
        else
        {
            ...
            I2C_1_rxBufferSize  = (uint8) config->rxBufferSize;

            /* Set TX direction internal variables */
            I2C_1_txBuffer      =         config->txBuffer;
            I2C_1_txDataBits    = (uint8) config->txDataBits;
            I2C_1_txBufferSize  = (uint8) config->txBufferSize;
...
void I2C_1_SpiPostEnable(void)
{
    ...
    I2C_1_SET_HSIOM_SEL(I2C_1_SCLK_M_HSIOM_REG, I2C_1_SCLK_M_HSIOM_MASK,
                                   I2C_1_SCLK_M_HSIOM_POS, I2C_1_HSIOM_SPI_SEL);
    ...
    I2C_1_SET_HSIOM_SEL(I2C_1_SS0_M_HSIOM_REG, I2C_1_SS0_M_HSIOM_MASK,
                                   I2C_1_SS0_M_HSIOM_POS, I2C_1_HSIOM_SPI_SEL);
    ...
    I2C_1_SET_HSIOM_SEL(I2C_1_SS1_M_HSIOM_REG, I2C_1_SS1_M_HSIOM_MASK,
                                   I2C_1_SS1_M_HSIOM_POS, I2C_1_HSIOM_SPI_SEL);
    ...
    I2C_1_SET_HSIOM_SEL(I2C_1_SS2_M_HSIOM_REG, I2C_1_SS2_M_HSIOM_MASK,
                                   I2C_1_SS2_M_HSIOM_POS, I2C_1_HSIOM_SPI_SEL);
    ...
    I2C_1_SET_HSIOM_SEL(I2C_1_SS3_M_HSIOM_REG, I2C_1_SS3_M_HSIOM_MASK,
                                   I2C_1_SS3_M_HSIOM_POS, I2C_1_HSIOM_SPI_SEL);
...
void I2C_1_SpiStop(void)
{
    ...
    if (I2C_1_CHECK_SPI_MASTER)
    {
        ...
        I2C_1_spi_sclk_Write(I2C_1_GET_SPI_SCLK_INACTIVE);

        /* Set GPIO to drive output pin */
        I2C_1_SET_HSIOM_SEL(I2C_1_SCLK_HSIOM_REG, I2C_1_SCLK_HSIOM_MASK,
                                       I2C_1_SCLK_HSIOM_POS, I2C_1_HSIOM_GPIO_SEL);
    #endif /* (I2C_1_MISO_SDA_TX_PIN_PIN) */

    #if (I2C_1_SS0_PIN)
        /* Set output pin state after block is disabled */
        I2C_1_spi_ss0_Write(I2C_1_GET_SPI_SS0_INACTIVE);

        /* Set GPIO to drive output pin */
        I2C_1_SET_HSIOM_SEL(I2C_1_SS0_HSIOM_REG, I2C_1_SS0_HSIOM_MASK,
                                       I2C_1_SS0_HSIOM_POS, I2C_1_HSIOM_GPIO_SEL);
    #endif /* (I2C_1_SS0_PIN) */
        ...
        /* Set GPIO to drive output pin */
        I2C_1_SET_HSIOM_SEL(I2C_1_SS1_HSIOM_REG, I2C_1_SS1_HSIOM_MASK,
                                       I2C_1_SS1_HSIOM_POS, I2C_1_HSIOM_GPIO_SEL);
    #endif /* (I2C_1_SS1_PIN) */
        ...
        /* Set GPIO to drive output pin */
        I2C_1_SET_HSIOM_SEL(I2C_1_SS2_HSIOM_REG, I2C_1_SS2_HSIOM_MASK,
                                       I2C_1_SS2_HSIOM_POS, I2C_1_HSIOM_GPIO_SEL);
    #endif /* (I2C_1_SS2_PIN) */
        ...
        /* Set GPIO to drive output pin */
        I2C_1_SET_HSIOM_SEL(I2C_1_SS3_HSIOM_REG, I2C_1_SS3_HSIOM_MASK,
                                       I2C_1_SS3_HSIOM_POS, I2C_1_HSIOM_GPIO_SEL);
    #endif /* (I2C_1_SS3_PIN) */
    }
    ...
    /* Set GPIO to drive output pin */
    I2C_1_SET_HSIOM_SEL(I2C_1_SCLK_M_HSIOM_REG, I2C_1_SCLK_M_HSIOM_MASK,
                                   I2C_1_SCLK_M_HSIOM_POS, I2C_1_HSIOM_GPIO_SEL);
#endif /* (I2C_1_MISO_SDA_TX_PIN_PIN) */
    ...
    /* Set GPIO to drive output pin */
    I2C_1_SET_HSIOM_SEL(I2C_1_SS0_M_HSIOM_REG, I2C_1_SS0_M_HSIOM_MASK,
                                   I2C_1_SS0_M_HSIOM_POS, I2C_1_HSIOM_GPIO_SEL);
#endif /* (I2C_1_SPI_MASTER_SS0_PIN) */
    ...
    /* Set GPIO to drive output pin */
    I2C_1_SET_HSIOM_SEL(I2C_1_SS1_M_HSIOM_REG, I2C_1_SS1_M_HSIOM_MASK,
                                   I2C_1_SS1_M_HSIOM_POS, I2C_1_HSIOM_GPIO_SEL);
#endif /* (I2C_1_SPI_MASTER_SS1_PIN) */
    ...
    /* Set GPIO to drive output pin */
    I2C_1_SET_HSIOM_SEL(I2C_1_SS2_M_HSIOM_REG, I2C_1_SS2_M_HSIOM_MASK,
                                   I2C_1_SS2_M_HSIOM_POS, I2C_1_HSIOM_GPIO_SEL);
#endif /* (I2C_1_SPI_MASTER_SS2_PIN) */
    ...
    /* Set GPIO to drive output pin */
    I2C_1_SET_HSIOM_SEL(I2C_1_SS3_M_HSIOM_REG, I2C_1_SS3_M_HSIOM_MASK,
                                   I2C_1_SS3_M_HSIOM_POS, I2C_1_HSIOM_GPIO_SEL);
#endif /* (I2C_1_SPI_MASTER_SS3_PIN) */
