...
#define SPIM_REMOVE_SPI_MASTER_SS0_PIN      (0u)
#define SPIM_REMOVE_SPI_MASTER_SS1_PIN      (0u)
#define SPIM_REMOVE_SPI_MASTER_SS2_PIN      (0u)
...
***************************************/
...
#if (SPIM_RX_WAKE_SCL_MOSI_PIN)
    #define SPIM_RX_WAKE_SCL_MOSI_HSIOM_REG \
                            (*(reg32 *) SPIM_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    #define SPIM_RX_WAKE_SCL_MOSI_HSIOM_PTR \
                            ( (reg32 *) SPIM_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    #define SPIM_RX_WAKE_SCL_MOSI_HSIOM_MASK \
                            (SPIM_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_MASK)
    #define SPIM_RX_WAKE_SCL_MOSI_HSIOM_POS \
                            (SPIM_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_SHIFT)

    #define SPIM_RX_WAKE_SCL_MOSI_INTCFG_REG \
                            (*(reg32 *) SPIM_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define SPIM_RX_WAKE_SCL_MOSI_INTCFG_PTR \
                            ( (reg32 *) SPIM_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define SPIM_RX_WAKE_SCL_MOSI_INTCFG_TYPE_POS  (SPIM_uart_rx_wake_i2c_scl_spi_mosi__SHIFT)
    #define SPIM_RX_WAKE_SCL_MOSI_INTCFG_TYPE_MASK \
                            ((uint32) SPIM_INTCFG_TYPE_MASK << \
    ...
    #define SPIM_TX_HSIOM_PTR   ( (reg32 *) SPIM_tx_0__HSIOM)
