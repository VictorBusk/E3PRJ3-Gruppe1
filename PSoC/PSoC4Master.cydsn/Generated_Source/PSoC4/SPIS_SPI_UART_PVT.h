...
***************************************/
    ...
    extern volatile uint16 SPIS_rxBufferInternal[SPIS_INTERNAL_RX_BUFFER_SIZE];
#endif /* (SPIS_INTERNAL_RX_SW_BUFFER) */

#if (SPIS_INTERNAL_TX_SW_BUFFER)
    extern volatile uint16 SPIS_txBufferInternal[SPIS_TX_BUFFER_SIZE];
