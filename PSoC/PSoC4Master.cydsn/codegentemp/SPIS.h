...
#define SPIS_EZBUF_DATA00_REG       (*(reg32 *) SPIS_SCB__EZ_DATA00)
#define SPIS_EZBUF_DATA00_PTR       ( (reg32 *) SPIS_SCB__EZ_DATA00)
...
#if (SPIS_CY_SCBIP_V0 || SPIS_CY_SCBIP_V1)
    #define SPIS_FF_DATA_NR_LOG2_PLUS1_MASK (0x0Fu) /* FF_DATA_NR_LOG2_PLUS1 = 4, MASK = 2^4 - 1 = 15 */
    #define SPIS_FF_DATA_NR_LOG2_MASK       (0x07u) /* FF_DATA_NR_LOG2 = 3, MASK = 2^3 - 1 = 7 */
#else
    #define SPIS_FF_DATA_NR_LOG2_PLUS1_MASK (0x1Fu) /* FF_DATA_NR_LOG2_PLUS1 = 5, MASK = 2^5 - 1 = 31 */
    #define SPIS_FF_DATA_NR_LOG2_MASK       (0x0Fu) /* FF_DATA_NR_LOG2 = 4, MASK = 2^4 - 1 = 15 */
#endif /* (SPIS_CY_SCBIP_V0 || SPIS_CY_SCBIP_V1) */
...
#define SPIS_FIFO_SIZE      (8u)   /* Size of TX or RX FIFO: defined by HW */
#define SPIS_EZBUFFER_SIZE  (32u)  /* EZ Buffer size: defined by HW        */
