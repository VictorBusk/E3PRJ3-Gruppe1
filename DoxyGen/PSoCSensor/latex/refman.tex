...
\input{class_queue}
\input{class_sensor_data}
\section{Fil-\/dokumentation}
\input{_circular_mean_8c}
\input{_circular_mean_8h}
\input{cyapicallbacks_8h}
\input{handler_8c}
\input{handler_8h}
\input{i2c_8c}
\input{i2c_8h}
\input{_lumen_sensor_8c}
\input{_lumen_sensor_8h}
\input{lux_8c}
\input{lux_8h}
\input{main_8c}
\input{queue_8c}
\input{queue_8h}
\input{_sensor_data_8c}
\input{_sensor_data_8h}
