...
\begin{center}
\leavevmode
\includegraphics[width=165pt]{lux_8h__dep__incl}
\end{center}
\end{figure}
...
226   \textcolor{comment}{// round lsb (2^(LUX\_SCALE−1))}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{lux_8h_a3db2aa0d603f0627be256dc108d3d763_icgraph}
\end{center}
\end{figure}
