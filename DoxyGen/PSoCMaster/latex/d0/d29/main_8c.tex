...
Indeholder referencer til Data\+::data\+\_\+init(), Queue\+::front\+Queue(), Handler\+::handler(), I2\+C\+::i2c\+\_\+init(), Queue\+::is\+Empty\+Queue(), L\+C\+D\+\_\+\+Init(), Queue\+::pop\+Queue(), Queue\+::queue\+\_\+init(), L\+E\+D\+::set\+Led() og S\+P\+I\+::spi\+\_\+init().
...
26   DEBUG\_Start();
27   
28   \hyperlink{class_l_e_d_a1d8e725e3829da99c1d027ba0a2ce57a}{setLed}(1,0,0,150);
29   \hyperlink{class_l_e_d_a1d8e725e3829da99c1d027ba0a2ce57a}{setLed}(0,1,0,150);
30   \hyperlink{class_l_e_d_a1d8e725e3829da99c1d027ba0a2ce57a}{setLed}(0,0,1,150);
31   
32   DEBUG\_PutCRLF();
33   DEBUG\_PutString(\textcolor{stringliteral}{"===== Initializing PSoC Master ====="});
34   DEBUG\_PutCRLF();
35   CyGlobalIntEnable; \textcolor{comment}{/* Enable global interrupts. */}
36   
37   \textcolor{keywordflow}{for}(;;)
38   \{
39     \hyperlink{class_l_e_d_a1d8e725e3829da99c1d027ba0a2ce57a}{setLed}(0,0,0,0);
40     
41     \textcolor{keywordflow}{while}(\hyperlink{class_queue_aafb324c79731abdc228dbf94d86722a3}{isEmptyQueue}() != 1)
42     \{
43       \textcolor{keyword}{struct }\hyperlink{queue_8h_df/d8c/struct_action}{Action} action;
44       action = \hyperlink{class_queue_a49c50ba30a42033068d8d8e6a23c6ca1}{frontQueue}();
45       \textcolor{keywordflow}{if}(action.cmd != 0)
46       \{
47         \hyperlink{class_handler_af5be5b016b862943cd22504490acc8f4}{handler}(action.cmd, action.val);
48       \}
49       \hyperlink{class_queue_a9ecab9ecdedfc331aed9a0ae63ce193b}{popQueue}();
50     \}
51   \}
52 \}
\end{DoxyCode}
