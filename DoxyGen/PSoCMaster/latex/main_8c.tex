...
Indeholder referencer til Data\+::data\+\_\+init(), Queue\+::front\+Queue(), Handler\+::handler(), I2\+C\+::i2c\+\_\+init(), Queue\+::is\+Empty\+Queue(), Queue\+::pop\+Queue(), Queue\+::queue\+\_\+init(), L\+E\+D\+::set\+Led() og S\+P\+I\+::spi\+\_\+init().
...
42     \{
43       \textcolor{keyword}{struct }\hyperlink{queue_8h_struct_action}{Action} action;
